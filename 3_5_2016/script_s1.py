...
kinc=bioDS(path="KinC_3_ir/")
kinc.load()
kina=bioDS(path="KinA_0/")
kina.load()
...
plt.plot(np.linspace(0,20,60),cc[2],label="KinC",linewidth=2.0)
...
plt.plot(np.linspace(0,20,60),aa[2],label="KinA",linewidth=2.0)
...
plt.plot([0,20],[2.3,2.3],"b--")
plt.xlabel("ViKin")
plt.ylabel("Spo0A_p")
plt.savefig("KinC_3_ir/threshold.pdf")
plt.show()
